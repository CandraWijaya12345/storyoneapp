...
import com.dicoding.storyoneapp.DataDummy
import com.dicoding.storyoneapp.MainDispatcherRule
...
import com.dicoding.storyoneapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(userRepository.getStories("token")).thenReturn(expectedQuote)
        ...
        val differ = AsyncPagingDataDiffer(
            diffCallback = MainActivityAdapter.DIFF_CALLBACK,
